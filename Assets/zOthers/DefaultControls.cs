...
public partial class @DefaultControls : IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""MouseClick"",
                    ""type"": ""Button"",
                    ""id"": ""ea560cbb-6f27-4240-b35a-12cc1bacc194"",
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""49901df8-c05d-4795-8e1d-8c3dead866b5"",
    ...
    ""controlSchemes"": []
        ...
        m_DefaultMap_MouseClick = m_DefaultMap.FindAction("MouseClick", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_DefaultMap_MouseClick;
    public struct DefaultMapActions
    {
        ...
        public InputAction @MouseClick => m_Wrapper.m_DefaultMap_MouseClick;
        ...
        public void SetCallbacks(IDefaultMapActions instance)
        {
            if (m_Wrapper.m_DefaultMapActionsCallbackInterface != null)
            {
                ...
                @MouseClick.started -= m_Wrapper.m_DefaultMapActionsCallbackInterface.OnMouseClick;
                @MouseClick.performed -= m_Wrapper.m_DefaultMapActionsCallbackInterface.OnMouseClick;
                @MouseClick.canceled -= m_Wrapper.m_DefaultMapActionsCallbackInterface.OnMouseClick;
            }
